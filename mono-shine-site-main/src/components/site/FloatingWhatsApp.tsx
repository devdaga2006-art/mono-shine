...
const FloatingWhatsApp = () => {
  return (
    <a
      ...
      className="fixed right-4 bottom-20 md:bottom-6 z-50 h-14 w-14 rounded-full bg-whatsapp text-whatsapp-foreground grid place-items-center shadow-[var(--shadow-lg)] transition-all duration-300 ease-out hover:scale-110 hover:shadow-[0_20px_50px_-20px_rgba(16,185,129,0.7)] float-soft"
    >
