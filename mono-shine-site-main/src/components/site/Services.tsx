      ...
      <div className="container-prose">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
          {POLYMERS.map((p) => (
            <article
              key={p.code}
              className="lift group bg-card border border-border rounded-xl p-6 shadow-[var(--shadow-card)] hover:border-primary/40"
            >
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5 mt-6">
          {SERVICES.map((s) => (
            <div
              key={s.title}
              className="lift bg-primary text-primary-foreground rounded-xl p-6 shadow-[var(--shadow-card)]"
            >
